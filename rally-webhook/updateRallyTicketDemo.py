...
#  python3 updateRallyTicketDemo.py <FormattedID> <PromotedImpactedDEMOEnvironment> --config=rallyuser.cfg
#
...
#  May 01, 2018    Prangya P Kar      Modified script to update PromotedImpactedDEMOEnvironment value for a given defect/UserStory
#
#
#################################################################################################
...
def usage():
    print("\n")
    usage_message_main = (
    "Usage: " + __file__ + " [-h] [--help] <DefectID/UserStoryID> <PromotedImpactedDEMOEnvironment> --config=<configFile>")
...
def main(args):
    ...
    defect_data = {"FormattedID": ticketID,
                   "PromotedImpactedDEMOEnvironment": PromotedImpactedEnvironment
                   }
    ...
    try:
        for proj in projects:
            ...
            if response.resultCount > 0:
                print("Workspace Name: %s , Project Name: %s , Entity Name: %s , Ticket Id: %s" % (
                workspace, proj.Name, entity_name, ticketID))
    ...
    print("PromotedImpactedDEMOEnvironment: " + PromotedImpactedEnvironment + "\n")
