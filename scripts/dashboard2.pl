...
print $fh "<tr bgcolor=\"#30aaf4\"><th colspan=\"100%\" align=\"left\"><font size=\"5\">IntelliStream environments dashboard</font> - Last run on $time_stamp PST<BR><a href=\"dashboard-popup.html\" target=\"_blank\">Click here to visit Dashboard version 2 beta!</a></th></tr>\n";
