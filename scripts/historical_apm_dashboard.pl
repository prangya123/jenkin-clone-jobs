...
my $RC_ALERTS_URL="https://apm-alarms-svc-rc.int-app.aws-usw02-pr.predix.io/system_status";
my $RC_CASES_URL="https://apm-cases-svc-rc.int-app.aws-usw02-pr.predix.io/system_status";
...
my $PP_ALERTS_URL="https://apm-alarms-svc-preprod.preprod-app-api.aws-usw02-pr.predix.io/system_status";
my $PP_CASES_URL="https://apm-cases-svc-preprod.preprod-app-api.aws-usw02-pr.predix.io/system_status";
...
my $PROD_ALERTS_URL="https://apm-alarms-svc-prod.app-api.aws-usw02-pr.predix.io/system_status";
my $PROD_CASES_URL="https://apm-cases-svc-prod.app-api.aws-usw02-pr.predix.io/system_status";
...
my $prod_ts_status;
my $prod_stuf_status;
my $prod_alerts_status;
my $prod_cases_status;
my $PROD_TOKEN;
my $prod_html_line;
...
printf "RC ALERTS STATUS IS $rc_alerts_status\n";
printf "RC CASES STATUS IS $rc_cases_status\n";
...
printf "PP ALERTS STATUS IS $pp_alerts_status\n";
printf "PP CASES STATUS IS $pp_cases_status\n";
...
printf "PROD ALERTS STATUS IS $prod_alerts_status\n";
printf "PROD CASES STATUS IS $prod_cases_status\n";
...
sub generate_line
{
    my ($time_stamp_passed, $uaa_status, $ts_status, $asset_status, $stuf_status, $alerts_status, $cases_status) = @_;
    my $uaa_color;
    my $uaa_hover;
    my $ts_color;
    my $ts_hover;
    ...
    if ($alerts_status ne "UP")
    {
        $alerts_hover = "<div title=\"$alerts_status\">DOWN</div>";
        $alerts_status = $alerts_hover;
        $alerts_color = "#FF0000";
    }
    else
    {
    ...
    if ($cases_status ne "UP")
    {
        $cases_hover = "<div title=\"$cases_status\">DOWN</div>";
        $cases_status = $cases_hover;
        $cases_color = "#FF0000";
    }
    else
    {
    ...
    $ret_val = "<tr bgcolor=\"#30aaf4\"><td NOWRAP>$time_stamp_passed</td><td bgcolor=\"$uaa_color\">$uaa_status</td><td bgcolor=\"$ts_color\">$ts_status</td><td bgcolor=\"$asset_color\">$asset_status</td><td bgcolor=\"$stuf_color\">$stuf_status</td><td bgcolor=\"$alerts_color\">$alerts_status</td><td bgcolor=\"$cases_color\">$cases_status</td></tr>";
