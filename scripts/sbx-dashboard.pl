...
my $perf02_sbx_space_id="af89bb29-9b25-4ec6-ac37-f1d712768d23";
...
my $perf02_analysis_sbx_space_id="149e63b7-9be6-4573-b4de-9706380eeccd";
...
$hash_ref = create_hash($perf02_sbx_space_id);
%perf02_hash = %$hash_ref;

$hash_ref = create_hash($perf02_analysis_sbx_space_id);
%perf02_analysis_hash = %$hash_ref;
%perf02_hash = (%perf02_hash, %perf02_analysis_hash);
...
print $fh "<tr bgcolor=\"#30aaf4\">\n<th NOWRAP>Sr. No.</th><th>Application Name</th><th>DEV02</th><th>QA02</th><th>PERF02</th><th>DEMODEV02</th><th>DEMOPROD02</th><th>BFX01</th></tr>\n";
...
for $app_name (@dev_apps)
{
    ...
    my $perf02_app = $perf02_hash{$app_name}[6];
    ...
    print $fh "<td NOWRAP BGCOLOR=\"$perf02_hash{$app_name}[5]\">$perf02_app <BR>Version: 1.0.0.$perf02_hash{$app_name}[0]<BR>Instances running: $perf02_hash{$app_name}[3]/$perf02_hash{$app_name}[4]<BR>Route: $perf02_hash{$app_name}[2]</td>";
